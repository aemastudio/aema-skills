...
- When creating or revising recurring characters, read [references/character-canon.md](references/character-canon.md) and produce a detailed character dossier rather than a one-line summary.
...
2. Create a canon ledger before long-form writing. Give recurring entities stable IDs: `CHAR-*`, `LOC-*`, and `PROP-*`. Every recurring character receives the detailed narrative and appearance fields in the character-canon contract.
...
- entity registry with stable IDs and aliases, including a detailed character dossier and casting constraints for every recurring character;
